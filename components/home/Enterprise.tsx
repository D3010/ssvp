      ...
      <div className="container-wide">
        <Reveal>
          <div className="relative overflow-hidden rounded-[28px] bg-[linear-gradient(120deg,#1b1640,#4f46e5_55%,#7c3aed)] p-10 md:p-16">
            ...
            {/* faint depth art + glossy pharmacy accents (decorative, moving) */}
            <Molecule className="pointer-events-none absolute -left-10 -bottom-12 z-0 w-48 opacity-20" />
            <Capsule className="pointer-events-none absolute right-10 -top-6 z-0 hidden w-32 -rotate-12 animate-float opacity-90 lg:block" />
            <PillBottle className="pointer-events-none absolute -right-3 bottom-3 z-0 hidden w-20 rotate-6 animate-bob opacity-95 md:block" />
