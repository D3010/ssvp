...
export function Hero() {
  ...
  return (
    <section className="relative overflow-hidden">
      {/* ── layered light backdrop (covers the whole hero) ─────────────── */}
      ...
      <div
        aria-hidden="true"
        className="pointer-events-none absolute left-1/2 -top-[14%] size-[680px] -translate-x-1/2 rounded-full bg-[radial-gradient(circle,color-mix(in_srgb,var(--brand-3)_22%,transparent),transparent_62%)] blur-2xl animate-aurora"
      />
      ...
      <div className="container-wide relative w-full">
        ...
        <motion.div
          ...
          initial="hidden"
          animate="show"
          className="mx-auto flex min-h-[calc(100svh-4rem)] max-w-3xl flex-col items-center justify-center py-14 text-center"
        >
          <motion.span
            variants={fade}
            className="inline-flex items-center gap-2.5 rounded-full border border-line bg-white/80 px-4 py-2 shadow-[0_1px_2px_0_rgba(20,21,43,0.05)] backdrop-blur-sm"
          >
          ...
          <motion.p variants={fade} className="mx-auto mt-6 max-w-xl text-lg leading-relaxed text-muted text-pretty">
          ...
          <motion.ul variants={fade} className="mt-9 flex flex-wrap items-center justify-center gap-x-6 gap-y-2.5">
        ...
        <motion.div
          ...
          className="relative mx-auto max-w-[640px] pb-24"
        >
